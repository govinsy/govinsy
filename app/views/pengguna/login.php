        ...
        <div class="col-lg-5">
            ...
            <div class="jumbotron mt-4 color-content py-5 px-5 text-center">
                <form class="form-signin" method="POST" action="<?= BASEURL; ?>/pengguna/login">
                    <img class="mb-5" src="<?= BASEURL; ?>/img/govinsy-dark.png" alt="" width="40%">
                    <?php Flasher::flash(); ?>
                    ...
                    <a href="<?= BASEURL; ?>/pengguna/lupapassword">lupa password?</a>
                    ...
                    <a href="<?= BASEURL; ?>/pengguna/daftar" class="btn btn-outline-blue corner-round btn-block">Daftar</a>
                </form>
            </div>
