  ...
  <div class="row">
    <div class="col-sm-12">
     <div class="col-sm-12 mb-4 color-light-font">
        <h2 class="mt-3 font-42 font-weight-bold">Privacy Policy</h2>
      <div class="col-sm-12">
        <h3 class="heading-2">
          <b>Kebijakan Privasi</b>
        </h3>
        <p>Govinsy memperlakukan privasi Anda dengan sungguh-sungguh. Bacalah uraian berikut untuk mengetahui lebih jauh mengenai kebijakan privasi kami.</p>
        
        <p class="m-code2">
          <strong>Yang Dicakup oleh Kebijakan Privasi ini</strong>
        </p>
        <ul class="m1-15">
          <li>Kebijakan Privasi ini mencakup perlakuan kami atas informasi yang dapat mengidentifikasi diri (data pribadi) Anda saat sedang berada di Aplikasi Govinsy, dan saat Anda menggunakan layanan kami. Kebijakan ini juga mencakup perlakukan kami atas data pribadi yang digunakan bersama oleh kami.</li>
        ...
        <ul class="m1-15">
          <li>Saat Anda mendaftar pada kami, kami menanyakan nama, alamat email, alamat tempat tinggal, tanggal lahir, dan nomor telepon. Setelah Anda mendaftar dan masuk ke layanan kami, Anda bukanlah orang yang anonim bagi kami.</li>
          <li>Kami menggunakan informasi untuk memenuhi permintaan Anda akan produk dan layanan tertentu.</li>
        </ul>


        <p class="m-code2">
          <strong>Perubahan terhadap Kebijakan Privasi ini</strong>
        </p>
        <ul class="m1-15">
        ...
        <p class="m-code2">
          <strong>Pengungkapan informasi anda</strong>
        </p>
        ...
        <ul class="m1-15">
          <li>Untuk memastikan bahwa isi dari situs kami disajikan dengan cara yang paling efektif untuk anda dan untuk perangkat anda.</li>
